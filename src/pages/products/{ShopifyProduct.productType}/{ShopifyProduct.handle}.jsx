...
export default function Product({ data: { product, suggestions } }) {
  ...
  const {
    ...
    description,
    media,
  } = (product || {variants: [],media:[], priceRangeV2: { minVariantPrice: { amount: 0, currencyCode: "USD"  } }});
...
export const query = graphql`
  query($id: String!, $productType: String!) {
    product: shopifyProduct(shopifyId: { eq: $id }) {
      title
      description
      productType
    ...
    suggestions: allShopifyProduct(
      limit: 3
      filter: { productType: { eq: $productType }, shopifyId: { ne: $id } }
    ) {
      nodes {
        ...ProductCard,
        key: id
